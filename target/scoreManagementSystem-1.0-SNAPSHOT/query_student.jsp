...
<div class="content-container">
    ...
    <div class="form-wrapper">
        <form action="query_student" method="post">
            查询方式：
            <select name="queryType" id="queryType" onchange="toggleStudentIdField()">
                <option value="all">全部查询</option>
                <option value="byId">按学号查询</option>
            </select><br><br>

            <div id="studentIdField" style="display: none;">
                学生ID：<input type="text" name="studentId"><br><br>
            </div>
...
<script>
    function toggleStudentIdField() {
        ...
        studentIdField.style.display = (queryType === "byId") ? "block" : "none";
    }
</script>
